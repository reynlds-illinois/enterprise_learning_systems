...
print('| COURSE_NAME   =', spaceInfo[0][17], '-', spaceInfo[0][18], '-', spaceInfo[0][19], '-', spaceInfo[0][20])
print('| TYPE_DESC     =', spaceInfo[0][11])
print('| REQUESTOR     =', spaceInfo[0][34])
print('| OWNER         =', spaceInfo[0][35])
print('| STATUS        =', spaceInfo[0][3], '-', spaceInfo[0][4])
print('| HOLD          =', spaceInfo[0][5])
print('| STAFF_COMMENT =', spaceInfo[0][39])
print('| USER_COMMENT  =', spaceInfo[0][38])
print('| CREATE_METHOD =', spaceInfo[0][6])
print('| TERM          =', spaceInfo[0][8], '-', spaceInfo[0][17])
print('| ACCESSIBLE    =', spaceInfo[0][44], 'to', spaceInfo[0][45])
print('| BANNER_DATES  =', spaceInfo[0][40], 'to', spaceInfo[0][41])
print('| ROSTER_LOAD   =', spaceInfo[0][42], 'to', spaceInfo[0][43])
if len(crnInfo) > 0:
